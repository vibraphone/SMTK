...
//----------------------------------------------------------------------------
Simple::Signal<void(Item*, int, const int&)> IntItem::s_valueChangeObserver;

template<>
Simple::Signal<void(Item*, int, const int&)>& ValueItemTemplate<int>::valueChangeObserver()
{
  return IntItem::s_valueChangeObserver;
}
